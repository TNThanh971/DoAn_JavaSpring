                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                <a class="primary_img" href="./productDetail?idProduct=${cloth.idProduct}"><img src="${cloth.productUrlImage}" alt=""></a>
                                                <a class="secondary_img" href="./productDetail?idProduct=${cloth.idProduct}"><img src="${cloth.productUrlImage}" alt=""></a>
                                            ...
                                            <div class="product_content grid_content">
                                                <h4 class="product_name"><a href="./productDetail?idProduct=${cloth.idProduct}">${cloth.productName}</a></h4>
                                                <div class="price_box"> 
