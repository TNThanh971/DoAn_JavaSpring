                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                <a class="primary_img" href="product-details.html"><img src="${accessory.productUrlImage}" alt=""></a>
                                                <a class="secondary_img" href="product-details.html"><img src="${accessory.productUrlImage}" alt=""></a>
                                            ...
                                            <div class="product_content grid_content">
                                                <h4 class="product_name"><a href="product-details.html">${accessory.productName}</a></h4>
                                                <div class="price_box"> 
