                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                <a class="primary_img" href="/prouctDetail?id=${wig.idProduct}"><img src="${wig.productUrlImage}" alt=""></a>
                                            ...
                                            <div class="product_content grid_content">
                                                <h4 class="product_name"><a href="product-details.html">${wig.productName}</a></h4>
                                                <div class="price_box"> 
